...
const pool = new Pool({
  user: "user_shoma_otsuka",//"user_3522", // PostgreSQLのユーザー名に置き換えてください
  host: "localhost",
  database: "db_shoma_otsuka",//"crm_3522", // PostgreSQLのデータベース名に置き換えてください
  password: "pass",//"pass_3522", // PostgreSQLのパスワードに置き換えてください
  port: 5432,
});
